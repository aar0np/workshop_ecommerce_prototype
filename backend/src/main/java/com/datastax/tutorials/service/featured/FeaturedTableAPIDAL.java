...
public class FeaturedTableAPIDAL {
	...
	public List<FeaturedTableEntity> getFeaturedProductById(int featuredId) {
		...
		TableCursor<FeaturedTableEntity, FeaturedTableEntity> results = featuredProductTable.find(Filters.eq("feature_id", featuredId));
		//TableCursor<FeaturedTableEntity, FeaturedTableEntity> results = featuredProductTable.find(Filters.eq("feature_id", featuredId), options);
