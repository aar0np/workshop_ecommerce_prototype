...
@EntityTable("product_vectors")
public class ProductVectorsTableEntity {
	 ...
	 * Constructor
	 */
	public ProductVectorsTableEntity() {}

	public ProductVectorsTableEntity(Product p) {
		this.productId = p.getProductId();
		this.images = p.getImages();
		this.name = p.getName();
		this.group = p.getProductGroup();
	}
